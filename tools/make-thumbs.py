...
SRC_DIRS = ['assets/Tshirt designs','assets/Floral','assets/Mythological','assets/Pop Culture','assets/Travel','assets/Stickers','assets/Wallpapers','assets/Figurines','posters','uploads']
SIZES = [480, 1080]
